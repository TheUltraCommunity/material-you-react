...
export default function SnackBar(props: SnackBarProps) {
    ...
    useEffect(() => {
        ...
        const calculateBottomBarOffset = () => {
            const bottomAppBar = document.getElementById('bottomAppBar');
            const bottomBarHeight = bottomAppBar?.getBoundingClientRect().height || 0;
            setBottomOffSet(bottomBarHeight > 0 ? bottomBarHeight + 16 : 16);
        };
        calculateBottomBarOffset();
        window.addEventListener('resize', calculateBottomBarOffset);
        ...
        return () => {
            window.removeEventListener('resize', calculateBottomBarOffset);
            clearTimeout(timer);
        };
    }, []);
        ...
        >
            <p
                style={{
                    ...
                    overflow: 'hidden',
                    width: props.variant === 'twoLine' ? '50%' : '',
                    display: '-webkit-box',
            ...
            >
                ...
                >
                    ...
                    // onClick={handleActionCallback}   // A callback function 
                    >
                        <p>{props.action}</p>
                    </TextButton>
